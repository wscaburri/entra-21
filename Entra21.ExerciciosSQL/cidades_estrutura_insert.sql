...
SELECT COUNT(cidade) AS 'Quantidade de Cidades de SP' FROM cidades WHERE estado = 'SP';

-- 9. Selecione o nome da cidade com a quantidade de caracteres, quando o nome da cidade conter 10 caracteres.
SELECT cidade, LEN(cidade) AS 'Quantidade de Caracteres' FROM cidades WHERE LEN(cidade) = 10;
